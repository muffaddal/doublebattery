<div class="my_meta_control">
    <p style="float:right">
        <a href="#" class="dodelete-ourteam button"><?php echo esc_html__('Remove All','lanethemekit') ?></a>
    </p>
    <div style="clear: both;margin-bottom: 15px;" ></div>
    <?php while($mb->have_fields_and_multi('ourteam',array('length' => 2))): ?>
        <?php $mb->the_group_open(); ?>
        <a href="#" class="dodelete button"><?php echo esc_html__('Remove','lanethemekit') ?></a>
        <?php $mb->the_field('socialName'); ?>
        <label><?php esc_html_e('Name', 'lanethemekit'); ?></label>
        ...
        <label><?php esc_html_e('Link', 'lanethemekit'); ?></label>
        <input class="form-control" type="text" name="<?php esc_attr($mb->the_name()); ?>" value="<?php esc_attr($mb->the_value()); ?>"/>

        <?php $mb->the_field('socialIcon'); ?>
        <label><?php esc_html_e('Icon', 'lanethemekit'); ?></label>
    ...
    <p>
        <a href="#" class="docopy-ourteam button"><?php esc_html_e('Add Social', 'lanethemekit'); ?></a>
        <input type="submit" class="button" name="save" value="<?php esc_html_e('Save', 'lanethemekit'); ?>">
    </p>
</div>
<style>
