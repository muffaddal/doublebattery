...
<div class="grid-posts">
    <div class="row">
        <?php while ( $my_query->have_posts() ): $my_query->the_post(); $post = fatotheme_get_post(); ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class('post-container post-visual col-sm-'.$column ); ?>>
