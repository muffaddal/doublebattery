...
$i_custom_background_color = $i_size = $i_css_animation = $descript = '';
...
if ($descript !== '') {
	$desc .= '<p class="heading-desc">'.$descript.'</p>';
}
$desc_align = ( '' !== $align ) ? ' vc_sep_pos_' . $align : '';

$separatorHtml = <<<TEMPLATE
<div class="heading-separator$desc_align">
...
TEMPLATE;
echo !empty( $separatorHtml ) ? $separatorHtml : '';
