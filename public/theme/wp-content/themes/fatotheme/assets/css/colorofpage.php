...
$main_color_of_page = get_post_meta( $pageid, '_fatotheme_main_color_of_page', true );
?>
<?php if($main_color_of_page!=''): ?>
...
body.header-absolute header.page-header.header-global .wez-mega-menu .wez-nav-menu.wez-nav-menu-horizontal > li.wez-menu-item.wez-active > a b.wez-caret:before, 
body.header-absolute header.page-header.header-global .wez-mega-menu .wez-nav-menu.wez-nav-menu-horizontal > li.wez-menu-item.current-menu-item > a b.wez-caret:before, 
body.header-absolute header.page-header.header-global .wez-mega-menu .wez-nav-menu.wez-nav-menu-horizontal > li.wez-menu-item.current-menu-ancestor > a b.wez-caret:before{
