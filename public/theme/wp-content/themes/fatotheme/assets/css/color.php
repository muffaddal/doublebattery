...
if(isset($fatotheme_theme_option['style_main_color']) && $fatotheme_theme_option['style_main_color']!='') {
    $main_color = $fatotheme_theme_option['style_main_color'];
}
if(isset($fatotheme_theme_option['style_main_custom']) && $fatotheme_theme_option['style_main_custom']!='') {
    $main_color = $fatotheme_theme_option['style_main_custom'];
} 
if(isset($fatotheme_theme_option['style_body_background']) && !empty($fatotheme_theme_option['style_body_background']['background-color'])){
    $background_color = 'background-color:'.$fatotheme_theme_option['style_body_background']['background-color'].';';
}else{
    $background_color = '';
}
if(isset($fatotheme_theme_option['style_body_background']) && !empty($fatotheme_theme_option['style_body_background']['background-repeat'])){
    $background_repeat = 'background-repeat:'.$fatotheme_theme_option['style_body_background']['background-repeat'].';';
}else{
    $background_repeat = '';
}
if(isset($fatotheme_theme_option['style_body_background']) && !empty($fatotheme_theme_option['style_body_background']['background-size'])){
    $background_size = 'background-size:'.$fatotheme_theme_option['style_body_background']['background-size'].';';
}else{
    $background_size = '';
}
if(isset($fatotheme_theme_option['style_body_background']) && !empty($fatotheme_theme_option['style_body_background']['background-attachment'])){
    $background_attachment = 'background-attachment:'.$fatotheme_theme_option['style_body_background']['background-attachment'].';';
}else{
    $background_attachment = '';
}
if(isset($fatotheme_theme_option['style_body_background']) && !empty($fatotheme_theme_option['style_body_background']['background-position'])){
    $background_position = 'background-position:'.$fatotheme_theme_option['style_body_background']['background-position'].';';
}else{
    $background_position = '';
}
if(isset($fatotheme_theme_option['style_body_background']) && !empty($fatotheme_theme_option['style_body_background']['background-image'])){
    $background_image = 'background-image: url("'.$fatotheme_theme_option['style_body_background']['background-image'].'");';
}else{
    $background_image = '';
}
?>
body.boxed{
  <?php 
  echo wp_kses_post($background_color);
  echo wp_kses_post($background_repeat);
  echo wp_kses_post($background_size);
  echo wp_kses_post($background_attachment);
  echo wp_kses_post($background_position);
  echo wp_kses_post($background_image);
  ?>
}
<?php if($main_color!='' && $main_color!='custom'): ?>
...
.woocommerce-page #customer_login form.register input[name="register"]:hover{
  background: <?php echo wp_kses_post($main_color) ?>;
  border-color: <?php echo wp_kses_post($main_color) ?>;
}
