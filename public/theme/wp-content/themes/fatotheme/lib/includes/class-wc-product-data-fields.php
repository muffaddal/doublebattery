...
/**
 * @class 		LT_WC_Product_Data_Fields
 * @version		0.1
 * @category	Class
 * @author 		Kharis Sulistiyono
 */

if(!class_exists('LT_WC_Product_Data_Fields')){
    ...
    class LT_WC_Product_Data_Fields {
        ...
        public function __construct(){
            LT_WC_Product_Data_Fields::$plugin_prefix = 'wc_productdata_options_';
            LT_WC_Product_Data_Fields::$plugin_basefile = plugin_basename(__FILE__);
            LT_WC_Product_Data_Fields::$plugin_url = plugin_dir_url(LT_WC_Product_Data_Fields::$plugin_basefile);
            LT_WC_Product_Data_Fields::$plugin_path = get_template_directory() . '/includes/';
        ...
        public function product_write_panel_tab(){
            ...
            $fields = fatotheme_wc_custom_product_data_fields();
                ...
                foreach($available_fields as $available_field){
                    ...
                    foreach ($fields as $field){
                        ...
                        if(!isset($field['tab_name'])){
                            ...
                            LT_WC_Product_Data_Fields::wc_product_data_options_fields($field);
...
$wc_cpdf = new LT_WC_Product_Data_Fields();
