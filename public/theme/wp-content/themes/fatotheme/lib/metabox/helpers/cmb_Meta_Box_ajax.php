...
class cmb_Meta_Box_ajax {
	...
	public static function get_oembed( $url, $object_id, $args = array() ) {
		...
		if ( $check_embed && $check_embed != $fallback )
			return '<div class="embed_status">'. $check_embed .'<p class="cmb_remove_wrapper"><a href="#" class="cmb_remove_file_button" rel="'. esc_attr($args['field_id']) .'">'. esc_html__( 'Remove Embed', 'cmb' ) .'</a></p></div>';
